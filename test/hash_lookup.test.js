...
test("idLookup matches Pascal probe trace", () => {
  ...
  for (const scenario of scenarios) {
    ...
    const actual = [
      ...
      `H${state.hash[973].rh},${state.hash[518].rh},${state.hash[800].rh},${state.hash[519].rh},${state.hash[2881].rh}`,
      `L${state.hash[973].lh}`,
...
test("primitive matches Pascal probe trace", () => {
  ...
  for (const scenario of scenarios) {
    ...
    const actual = [
      ...
      `CV${state.curVal}`,
      `SP${state.strPtr},${state.poolPtr}`,
      `H${state.hash[900].rh},${state.hash[322].rh}`,
      `E322${state.eqtb[322].hh.b0},${state.eqtb[322].hh.b1},${state.eqtb[322].hh.rh}`,
      `E900${state.eqtb[900].hh.b0},${state.eqtb[900].hh.b1},${state.eqtb[900].hh.rh}`,
